...
import database.writingstrategy.MySQLStrategy;
...
public class DatabaseController {
	 ...
	 */
	private DatabaseSavingStrategy strategy = new MySQLStrategy();//new TextFileStrategy();
	 ...
	 */
	public void load() {
		if(strategy instanceof MySQLStrategy) {
			return;
		}
