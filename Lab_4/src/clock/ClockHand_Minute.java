...
public class ClockHand_Minute implements GraphicComponent {
	...
	public ClockHand_Minute(Applet clock, CurrentTime timeFetcher) {
		this.screen = clock;
	...
	public void step() {
		...
		angle =((time.getTime().getMinutes()/60.0)*2*Math.PI); //in radians
